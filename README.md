...
- `Connect shapes`: adds thin random-color curved links between nearby shape assets, with occasional longer accents
...
- `Connect shapes` can add 1-2px curved linking strokes between nearby shape elements, with a few longer accent links.
